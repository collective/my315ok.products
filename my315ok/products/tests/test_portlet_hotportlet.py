...
from my315ok.products.portlets import hotportlet as myportlet
...
class TestPortlet(unittest.TestCase):
    ...
    def testPortletTypeRegistered(self):
        portlet = getUtility(IPortletType, name='my315ok.products.portlets.HotPortlet')
        self.assertEquals(portlet.addview, 'my315ok.products.portlets.HotPortlet')
