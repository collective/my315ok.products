...
class TestPortlet(unittest.TestCase):
    ...
    def testPortletTypeRegistered(self):
        portlet = getUtility(IPortletType, name='my315ok.products.portlets.RecommendPortlet')
        self.assertEquals(portlet.addview, 'my315ok.products.portlets.RecommendPortlet')
