...
class Ihot_goods_portlet(IPortletDataProvider):
    """A portlet
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('hot_goods_portlet.pt')
...
#                bs is a brain of goods              
    ...
    def get_goods_img(self,brain,scale):
        ...
        imgtag = "<img src='%s' alt='%s' />" % (surl,tl)
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(Ihot_goods_portlet)
